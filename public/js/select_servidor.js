...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('servidores', {
  ...
  mounted: function mounted() {
    ...
    axios.get('/empregados/apiServidor').then(function (response) {
      return _this.tasks = response.data;
    });
  }
});

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('servidor', {
