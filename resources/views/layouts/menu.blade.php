<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <!-- search form -->
    {!! Form::open(['url'=>'alunos', 'method'=>'get', 'class'=>'sidebar-form']) !!}
    ...
    <ul class="sidebar-menu">
      ...
      <!-- Menu Secretaria -->
      @if(Auth::check() && Auth::user()->isRole('administrador|secretaria'))
      <li class="treeview">
        <a href="#">
          <i class="fa fa-sliders"></i> <span>Secretaria</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          <li class="active"><a href="{{ route('passivos.index')}}"><i class="fa fa-search"></i> Passivos</a></li>
        </ul>
      </li>
      @endif
      <!-- Menu Usuários -->
      ...
      @if(Auth::check() && Auth::user()->hasPermission('view.turma'))
        <li class="treeview">
          <a href="{{route('turmas.index')}}">
            <i class="fa fa-list-ul"></i> <span>Turmas</span>
          </a>
        </li>
      @endif
      ...
      @if(Auth::check() && Auth::user()->hasPermission('create.disciplinar'))
        <li class="treeview">
          <a href="{{route('ocorrencias.index')}}">
            <i class="fa fa-balance-scale"></i> <span>Disciplinar</span>
          </a>
        </li>
      @endif
      ...
      @if(Auth::check() && Auth::user()->isRole('administrador|diretor|administrativo'))
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('pedagogico.conselheiros')}}"><i class="fa fa-feed"></i> Conselheiros</a></li>
